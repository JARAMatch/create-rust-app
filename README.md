[![Rust Continuous Integration](https://github.com/JARAMatch/create-rust-app/actions/workflows/CI.yml/badge.svg)](https://github.com/JARAMatch/create-rust-app/actions/workflows/CI.yml)
